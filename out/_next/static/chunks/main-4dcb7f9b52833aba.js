      ...
      class $ {
        ...
        change(e, t, r, o, i) {
          ...
          return n(function* () {
            ...
            let q = 1 === o._h;
            q || o.shallow || (yield d._bfl(r, void 0, o.locale));
            let W =
                q ||
            ...
            d.isReady = !0;
            let V = d.isSsr;
            if ((q || (d.isSsr = !1), q && d.clc)) return !1;
            let Y = z.locale;
            h.ST && performance.mark("routeChange");
            let { shallow: K = !1, scroll: J = !0 } = o,
              Q = { shallow: K };
            d._inFlightRoute &&
              d.clc &&
              (V || $.events.emit("routeChangeError", k(), d._inFlightRoute, Q),
              d.clc(),
              (d.clc = null)),
              (r = E.addBasePath(
                b.addLocale(
            ...
            let ee = S.removeLocale(
              x.hasBasePath(r) ? w.removeBasePath(r) : r,
              z.locale
            );
            d._inFlightRoute = r;
            let et = Y !== z.locale;
            if (!q && d.onlyAHashChange(ee) && !et) {
              (z.asPath = ee),
                $.events.emit("hashChangeStart", r, Q),
              ...
              try {
                ...
                throw (
                  (c.default(e) &&
                    e.cancelled &&
                    $.events.emit("routeChangeError", e, ee, Q),
                  e)
                );
              }
            ...
            let er = g.parseRelativeUrl(t),
              { pathname: en, query: ea } = er;
            if (null == (n = d.components[en]) ? void 0 : n.__appRouter)
              return X({ url: r, router: d }), new Promise(() => {});
            try {
            ...
            let ei = l.removeTrailingSlash(en),
              ...
              es = !!(
                ...
                ei !== el &&
                (!m.isDynamicRoute(ei) ||
                  !y.getRouteMatcher(v.getRouteRegex(ei))(el))
              ),
              eu =
                !o.shallow &&
                (yield D({ asPath: r, locale: z.locale, router: d }));
            if (
              (q && eu && (W = !1),
              W &&
                "/_error" !== en &&
                ...
                er.pathname === en ||
                  ((en = er.pathname),
                  (er.pathname = E.addBasePath(en)),
                  eu || (t = _.formatWithValidation(er)))),
              !M.isLocalURL(r))
            )
              return X({ url: r, router: d }), !1;
            (eo = S.removeLocale(w.removeBasePath(eo), z.locale)),
              (ei = l.removeTrailingSlash(en));
            let ec = !1;
            ...
            q || $.events.emit("routeChangeStart", r, Q);
            ...
            try {
              let n = yield d.getRouteInfo({
                ...
                isQueryUpdating: q && !d.isFallback,
              ...
              if (
                ...
                (ei = en = n.route || ei),
                  Q.shallow || (ea = Object.assign({}, n.query || {}, ea));
                let e = x.hasBasePath(er.pathname)
                  ? w.removeBasePath(er.pathname)
                  : er.pathname;
                if (
                  (ec &&
                    en !== e &&
              ...
              if ("type" in n) {
                ...
                return (
                  X({ url: n.destination, router: d }), new Promise(() => {})
                );
              }
              let l = n.Component;
              ...
              $.events.emit("beforeHistoryChange", r, Q),
                d.changeState(e, t, r, o);
              let S = q && !_ && !G && !et && R.compareRouterStates(P, d.state);
              if (!S) {
                try {
                  yield d.set(P, n, _);
                } catch (e) {
                ...
                if (n.error)
                  throw (
                    (q || $.events.emit("routeChangeError", n.error, ee, Q),
                    n.error)
                  );
                q || $.events.emit("routeChangeComplete", r, Q),
        ...
        prefetch(e) {
          ...
          return n(function* () {
            ...
            let n = g.parseRelativeUrl(e),
              ...
              c = s,
              d = yield o.pageLoader.getPageList(),
              f = t,
              p = void 0 !== r.locale ? r.locale || void 0 : o.locale,
              h = yield D({ asPath: t, locale: p, router: o });
            ...
            if (
              ((null == b ? void 0 : b.effect.type) === "rewrite" &&
                ...
                (s = b.effect.resolvedHref),
                (u = a({}, u, b.effect.parsedAs.query)),
                (f = b.effect.parsedAs.pathname),
                (e = _.formatWithValidation(n))),
              (null == b ? void 0 : b.effect.type) === "redirect-external")
            )
              return;
            let S = l.removeTrailingSlash(s);
            (yield o._bfl(t, f, r.locale, !0)) &&
              (o.components[i] = { __appRouter: !0 }),
              yield Promise.all([
                o.pageLoader._isSsg(S).then(
                  (t) =>
                    !!t &&
                    G({
                ...
                o.pageLoader[r.priority ? "loadPage" : "prefetch"](S),
              ]);
          })();
        }
        fetchComponent(e) {
    ...
    2721: function (e, t, r) {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        (t.addLocale = function (e, t, r, o) {
          ...
          let i = e.toLowerCase();
          return !o &&
            (a.pathHasPrefix(i, "/api") ||
              a.pathHasPrefix(i, "/".concat(t.toLowerCase())))
            ? e
        ...
        return {
          parameterizedRoute: t
            .map((e) => {
              ...
              {
                let { key: t, optional: a, repeat: o } = l(e.slice(1, -1));
                return (
          ...
          namedParameterizedRoute: s
            .map((e) => {
              if (!(e.startsWith("[") && e.endsWith("]")))
                return "/".concat(a.escapeStringRegexp(e));
              {
                let { key: r, optional: n, repeat: a } = l(e.slice(1, -1)),
                  o = r.replace(/\W/g, ""),
                  s = !1;
                return (
                  ...
                  s && (o = u()),
                  t
                    ? (c[(o = "".concat(i).concat(o))] = "".concat(i).concat(r))
                    : (c[o] = "".concat(r)),
                  a
                    ? n
                      ? "(?:/(?<".concat(o, ">.+?))?")
